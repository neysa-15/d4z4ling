...
LONG_D4Z4="inputs/4A161L.fa"

OUTDIR=$1 #"PS1509" # variable
PREFIX=$2 #"PS1509" # variable
...
blat "${OUTDIR}/${PREFIX}_long.fasta" "${LONG_D4Z4}" "${OUTDIR}/${PREFIX}_4a_long_blat_output.psl"
...
grep -F -f "${OUTDIR}/${PREFIX}_long_d4z4_readIDs.txt" "${OUTDIR}/${PREFIX}_4a_long_blat_output.bed" > "${OUTDIR}/${PREFIX}_4a_long_repeats_final.bed"
